...
const LOCAL_Q = [
  ...
  {id:3,text_de:'Was bedeutet dieses Zeichen?',text_fa:'این علامت چه معنایی دارد؟',text_az:'Bu işarə nə deməkdir?',text_en:'What does this sign mean?',img_url:'https://upload.wikimedia.org/wikipedia/commons/thumb/b/ba/Zeichen_274-50.svg/200px-Zeichen_274-50.svg.png',opts:[{text_de:'Höchstgeschwindigkeit 50 km/h',text_fa:'حداکثر سرعت ۵۰ کیلومتر',text_az:'Maksimum sürət 50 km/s',text_en:'Maximum speed 50 km/h',ok:true},{text_de:'Mindestgeschwindigkeit 50 km/h',text_fa:'حداقل سرعت ۵۰',text_az:'Minimum sürət 50',text_en:'Minimum speed 50',ok:false},{text_de:'Empfohlene Geschwindigkeit',text_fa:'سرعت توصیه‌شده',text_az:'Tövsiyə olunan sürət',text_en:'Recommended speed',ok:false}]},
  {id:4,text_de:'Was bedeutet dieses Zeichen?',text_fa:'این علامت چه معنایی دارد؟',text_az:'Bu işarə nə deməkdir?',text_en:'What does this sign mean?',img_url:'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4e/Zeichen_274-120.svg/200px-Zeichen_274-120.svg.png',opts:[{text_de:'Höchstgeschwindigkeit 120 km/h',text_fa:'حداکثر سرعت ۱۲۰',text_az:'Maksimum sürət 120',text_en:'Maximum speed 120',ok:true},{text_de:'130 km/h',text_fa:'۱۳۰ کیلومتر',text_az:'130 km/s',text_en:'130 km/h',ok:false},{text_de:'100 km/h',text_fa:'۱۰۰ کیلومتر',text_az:'100 km/s',text_en:'100 km/h',ok:false}]},
  {id:5,text_de:'Was bedeutet dieses Zeichen?',text_fa:'این علامت چه معنایی دارد؟',text_az:'Bu işarə nə deməkdir?',text_en:'What does this sign mean?',img_url:'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c8/Zeichen_276.svg/200px-Zeichen_276.svg.png',opts:[{text_de:'Überholen verboten',text_fa:'سبقت ممنوع',text_az:'Ötmə qadağan',text_en:'No overtaking',ok:true},{text_de:'Gegenverkehr',text_fa:'ترافیک مقابل',text_az:'Əks trafik',text_en:'Oncoming traffic',ok:false},{text_de:'Einbahnstrasse',text_fa:'خیابان یک‌طرفه',text_az:'Birtərəfli yol',text_en:'One way street',ok:false}]},
  {id:6,text_de:'Welches ist die Höchstgeschwindigkeit auf Schweizer Autobahnen?',text_fa:'حداکثر سرعت در اتوبان‌های سوئیس چقدر است؟',text_az:'İsveçrə avtomobil yollarında maksimum sürət nədir?',text_en:'What is the maximum speed on Swiss motorways?',img_url:'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4e/Zeichen_274-120.svg/200px-Zeichen_274-120.svg.png',opts:[{text_de:'120 km/h',text_fa:'۱۲۰ کیلومتر',text_az:'120 km/s',text_en:'120 km/h',ok:true},{text_de:'130 km/h',text_fa:'۱۳۰',text_az:'130',text_en:'130 km/h',ok:false},{text_de:'100 km/h',text_fa:'۱۰۰',text_az:'100',text_en:'100 km/h',ok:false}]},
  {id:7,text_de:'Wer hat Vortritt an einer Kreuzung ohne Zeichen?',text_fa:'در تقاطع بدون علامت چه کسی حق تقدم دارد؟',text_az:'İşarəsiz kəsişmədə kim üstünlüyə malikdir?',text_en:'Who has priority at an unmarked junction?',img_url:'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e9/Zeichen_102.svg/200px-Zeichen_102.svg.png',opts:[{text_de:'Fahrzeuge von rechts',text_fa:'وسایل نقلیه از راست',text_az:'Sağdan gələn nəqliyyat',text_en:'Vehicles from the right',ok:true},{text_de:'Fahrzeuge von links',text_fa:'از چپ',text_az:'Soldan',text_en:'From the left',ok:false},{text_de:'Wer zuerst kommt',text_fa:'هر که اول رسید',text_az:'Kim əvvəl gəldi',text_en:'First come first served',ok:false}]},
  {id:8,text_de:'Wie viel Promille Alkohol ist beim Fahren erlaubt?',text_fa:'حداکثر میزان الکل خون هنگام رانندگی چقدر است؟',text_az:'Sürmə zamanı nə qədər alkoqol icazəlidir?',text_en:'How much alcohol is allowed when driving?',img_url:'https://upload.wikimedia.org/wikipedia/commons/thumb/b/ba/Zeichen_274-50.svg/200px-Zeichen_274-50.svg.png',opts:[{text_de:'0,5 Promille (Neulenker: 0,1)',text_fa:'۰.۵ در هزار (تازه‌کار: ۰.۱)',text_az:'0,5 ppm (yeni sürücü: 0,1)',text_en:'0.5 per mille (new drivers: 0.1)',ok:true},{text_de:'0,8 Promille',text_fa:'۰.۸ در هزار',text_az:'0,8 ppm',text_en:'0.8 per mille',ok:false},{text_de:'0,0 Promille',text_fa:'صفر',text_az:'0,0 ppm',text_en:'0.0 per mille',ok:false}]},
  {id:9,text_de:'Was bedeutet dieses Zeichen?',text_fa:'این علامت چه معنایی دارد؟',text_az:'Bu işarə nə deməkdir?',text_en:'What does this sign mean?',img_url:'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a8/Zeichen_286.svg/200px-Zeichen_286.svg.png',opts:[{text_de:'Halten und Parkieren verboten',text_fa:'توقف و پارک ممنوع',text_az:'Dayanmaq və park etmək qadağan',text_en:'No stopping or parking',ok:true},{text_de:'Nur Parkieren verboten',text_fa:'فقط پارک ممنوع',text_az:'Yalnız park qadağan',text_en:'No parking only',ok:false},{text_de:'Einfahrt verboten',text_fa:'ورود ممنوع',text_az:'Giriş qadağan',text_en:'No entry',ok:false}]},
  {id:10,text_de:'Was bedeutet dieses Zeichen?',text_fa:'این علامت چه معنایی دارد؟',text_az:'Bu işarə nə deməkdir?',text_en:'What does this sign mean?',img_url:'https://upload.wikimedia.org/wikipedia/commons/thumb/3/38/Zeichen_201.svg/200px-Zeichen_201.svg.png',opts:[{text_de:'Bahnübergang ohne Schranken',text_fa:'تقاطع راه‌آهن بدون دروازه',text_az:'Dərəzəsiz dəmir yolu keçidi',text_en:'Level crossing without gates',ok:true},{text_de:'Bahnübergang mit Schranken',text_fa:'با دروازه',text_az:'Dərəzəli',text_en:'With gates',ok:false},{text_de:'Haltestelle',text_fa:'ایستگاه',text_az:'Dayanacaq',text_en:'Bus stop',ok:false}]},
  {id:11,text_de:'Ist der Sicherheitsgurt Pflicht?',text_fa:'استفاده از کمربند ایمنی اجباری است؟',text_az:'Təhlükəsizlik kəməri məcburidir?',text_en:'Is the seatbelt compulsory?',img_url:'https://upload.wikimedia.org/wikipedia/commons/thumb/1/14/Zeichen_101.svg/200px-Zeichen_101.svg.png',opts:[{text_de:'Ja, für alle Insassen',text_fa:'بله، برای همه سرنشینان',text_az:'Bəli, bütün sərnişinlər üçün',text_en:'Yes, for all passengers',ok:true},{text_de:'Nur für Fahrer',text_fa:'فقط راننده',text_az:'Yalnız sürücü',text_en:'Driver only',ok:false},{text_de:'Freiwillig',text_fa:'اختیاری',text_az:'İxtiyari',text_en:'Optional',ok:false}]},
  {id:12,text_de:'Was bedeutet dieses Zeichen?',text_fa:'این علامت چه معنایی دارد؟',text_az:'Bu işarə nə deməkdir?',text_en:'What does this sign mean?',img_url:'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4c/Zeichen_301.svg/200px-Zeichen_301.svg.png',opts:[{text_de:'Ich habe Vorfahrt',text_fa:'من حق تقدم دارم',text_az:'Mənim üstünlüyüm var',text_en:'I have priority',ok:true},{text_de:'Vorfahrt gewähren',text_fa:'حق تقدم بده',text_az:'Üstünlük ver',text_en:'Give way',ok:false},{text_de:'Halt',text_fa:'ایست',text_az:'Dur',text_en:'Stop',ok:false}]},
  {id:13,text_de:'Was bedeutet dieses Zeichen?',text_fa:'این علامت چه معنایی دارد؟',text_az:'Bu işarə nə deməkdir?',text_en:'What does this sign mean?',img_url:'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e4/Zeichen_350-10.svg/200px-Zeichen_350-10.svg.png',opts:[{text_de:'Fussgängerstreifen',text_fa:'خط عابر پیاده',text_az:'Piyada keçidi',text_en:'Pedestrian crossing',ok:true},{text_de:'Schulübergang',text_fa:'گذرگاه مدرسه',text_az:'Məktəb keçidi',text_en:'School crossing',ok:false},{text_de:'Spielstrasse',text_fa:'خیابان بازی',text_az:'Oyun küçəsi',text_en:'Play street',ok:false}]},
  {id:14,text_de:'Muss man tagsüber Licht fahren?',text_fa:'آیا در روز باید چراغ روشن باشد؟',text_az:'Gündüzlər işıq yandırmaq məcburidir?',text_en:'Must lights be on during the day?',img_url:'https://upload.wikimedia.org/wikipedia/commons/thumb/1/14/Zeichen_101.svg/200px-Zeichen_101.svg.png',opts:[{text_de:'Ja, Tagfahrlicht ist Pflicht',text_fa:'بله، چراغ روز اجباری است',text_az:'Bəli, gündüz işıqları məcburidir',text_en:'Yes, daytime lights are compulsory',ok:true},{text_de:'Nein, nur nachts',text_fa:'نه، فقط شب',text_az:'Xeyr, yalnız gecə',text_en:'No, only at night',ok:false},{text_de:'Nur im Winter',text_fa:'فقط زمستان',text_az:'Yalnız qışda',text_en:'Only in winter',ok:false}]},
  {id:15,text_de:'Was bedeutet dieses Zeichen?',text_fa:'این علامت چه معنایی دارد؟',text_az:'Bu işarə nə deməkdir?',text_en:'What does this sign mean?',img_url:'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d2/Zeichen_327.svg/200px-Zeichen_327.svg.png',opts:[{text_de:'Tunnel',text_fa:'تونل',text_az:'Tunel',text_en:'Tunnel',ok:true},{text_de:'Unterführung',text_fa:'زیرگذر',text_az:'Alt keçid',text_en:'Underpass',ok:false},{text_de:'Brücke',text_fa:'پل',text_az:'Körpü',text_en:'Bridge',ok:false}]},
  {id:16,text_de:'Was bedeutet dieses Zeichen?',text_fa:'این علامت چه معنایی دارد؟',text_az:'Bu işarə nə deməkdir?',text_en:'What does this sign mean?',img_url:'https://upload.wikimedia.org/wikipedia/commons/thumb/1/14/Zeichen_101.svg/200px-Zeichen_101.svg.png',opts:[{text_de:'Gefahrenstelle',text_fa:'محل خطر',text_az:'Təhlükəli yer',text_en:'Danger spot',ok:true},{text_de:'Baustelle',text_fa:'کارگاه',text_az:'Tikinti',text_en:'Construction',ok:false},{text_de:'Schule',text_fa:'مدرسه',text_az:'Məktəb',text_en:'School',ok:false}]},
  {id:17,text_de:'Was bedeutet dieses Zeichen?',text_fa:'این علامت چه معنایی دارد؟',text_az:'Bu işarə nə deməkdir?',text_en:'What does this sign mean?',img_url:'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4a/Zeichen_274-80.svg/200px-Zeichen_274-80.svg.png',opts:[{text_de:'Höchstgeschwindigkeit 80 km/h',text_fa:'حداکثر سرعت ۸۰',text_az:'Maksimum sürət 80',text_en:'Maximum speed 80',ok:true},{text_de:'100 km/h',text_fa:'۱۰۰',text_az:'100',text_en:'100',ok:false},{text_de:'60 km/h',text_fa:'۶۰',text_az:'60',text_en:'60',ok:false}]},
  {id:18,text_de:'Was bedeutet dieses Zeichen?',text_fa:'این علامت چه معنایی دارد؟',text_az:'Bu işarə nə deməkdir?',text_en:'What does this sign mean?',img_url:'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f3/Zeichen_267.svg/200px-Zeichen_267.svg.png',opts:[{text_de:'Einfahrt verboten',text_fa:'ورود ممنوع',text_az:'Giriş qadağan',text_en:'No entry',ok:true},{text_de:'Halt',text_fa:'ایست',text_az:'Dur',text_en:'Stop',ok:false},{text_de:'Parkieren verboten',text_fa:'پارک ممنوع',text_az:'Park qadağan',text_en:'No parking',ok:false}]},
  {id:19,text_de:'Was bedeutet dieses Zeichen?',text_fa:'این علامت چه معنایی دارد؟',text_az:'Bu işarə nə deməkdir?',text_en:'What does this sign mean?',img_url:'https://upload.wikimedia.org/wikipedia/commons/thumb/b/ba/Zeichen_330.1.svg/200px-Zeichen_330.1.svg.png',opts:[{text_de:'Beginn der Autobahn',text_fa:'آغاز اتوبان',text_az:'Avtomobil yolunun başlanğıcı',text_en:'Start of motorway',ok:true},{text_de:'Ende der Autobahn',text_fa:'پایان اتوبان',text_az:'Sonu',text_en:'End of motorway',ok:false},{text_de:'Schnellstrasse',text_fa:'بزرگراه',text_az:'Sürətli yol',text_en:'Express road',ok:false}]},
  {id:20,text_de:'Welches ist die Höchstgeschwindigkeit innerhalb einer Ortschaft?',text_fa:'حداکثر سرعت داخل شهر چقدر است؟',text_az:'Yaşayış məntəqəsində maksimum sürət nədir?',text_en:'What is the maximum speed in a built-up area?',img_url:'https://upload.wikimedia.org/wikipedia/commons/thumb/b/ba/Zeichen_274-50.svg/200px-Zeichen_274-50.svg.png',opts:[{text_de:'50 km/h',text_fa:'۵۰ کیلومتر',text_az:'50 km/s',text_en:'50 km/h',ok:true},{text_de:'60 km/h',text_fa:'۶۰',text_az:'60',text_en:'60',ok:false},{text_de:'80 km/h',text_fa:'۸۰',text_az:'80',text_en:'80',ok:false}]},
];
      ...
      <SafeAreaView style={[s.safe, {backgroundColor:'#F8FAFF'}]}>
        ...
        <ScrollView style={s.examScroll} showsVerticalScrollIndicator={false}>
          <Animated.View style={{opacity:fadeAnim}}>
            {(curQ.img_url || (curQ as any).img) ? <Image source={{uri: curQ.img_url || (curQ as any).img}} style={s.qImg} resizeMode="contain" /> : null}
